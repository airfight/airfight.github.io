/**
 * Created by zhuguangyang on 15/5/8.
 */
var githubHeaderTitle = "GiantForJade-iOS备忘  &nbsp;&nbsp;&nbsp; 2015-06-06"
...
var githubList =  [
    ...
    {name:'GiantForJade',
        list:[
            {name:'不喜勿喷', url:'https://github.com/airfight',  owner:'google',
                desc:'🐖,2016新的开始'}
        ]
    },
    {name:'苹果官方文档',
        list:[
            {name:'API Reference', url:'https://developer.apple.com/reference/',  owner:'google',
                desc:'For Better'}
        ]
    },
    {name:'小小Tips',
        list:[
            {name:'腾讯bugly符号化iOS应用崩溃日志', url:'http://www.jianshu.com/p/3301acbc02b3',  owner:'google',
                desc:'For Better'}
        ]
    },
    {name:'导航返回',
        list:[
            {
                name:'KMNavigationBarTransition',url:'https://github.com/MoZhouqi/KMNavigationBarTransition',owner:'GYJade',desc:'For Better'
            }
        ]
    ...
    },
    {
      name:'HTTP',
        list:[
            {
                name:'MQTT',url:'https://github.com/mqtt/mqtt.github.io/wiki/libraries',owner:'GYJade',desc:'For Better'
            }
        ]
    ...
    },
    {
        ...
        list:[
            {
                name:'高仿美团HD',url:'https://github.com/XLAccount/XLGroupBuy',owner:'GYJade',desc:'For Better'
            }
        ]
    ...
    ,
    {
        ...
        list:[
            {
                name:'图文混排框架',url:'https://github.com/waynezxcv/Gallop',owner:'GYJade',desc:'For Better'
            }
        ]
